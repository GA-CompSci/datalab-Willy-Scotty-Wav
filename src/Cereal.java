...
public class Cereal {
    ...
    public Cereal(String name, int calories, int fiber, int carboydrates, double cups){
        this.name = name;
        this.calories = calories;
        this.fiber = fiber;
        this.carbohydrates = carboydrates;
        this.cups = cups;
    ...
    public String toString(){
        return name+ "- Calories: " + calories+ ", Fiber:" + fiber + ", Carbohydrates: " + carbohydrates+ ", Cups: " + cups;
    }
